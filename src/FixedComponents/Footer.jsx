    ...
    return (
        <div className="mt-12">
            <footer className="footer p-10 bg-neutral text-neutral-content">
                <aside>
                    <div>
                        <img className="w-[45px] h-[45px] rounded-full" src="/taskLogo.png" alt="" />
                    </div>
                    <p>Seamlessly Manage Tasks and Collaborate with <br />SCC Technovision's Task Management Platform.</p>
                </aside>
                <nav>
